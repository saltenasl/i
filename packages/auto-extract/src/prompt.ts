export const buildSystemPromptV2 = (): string => {
  return [
    ...
    '- If first-person pronouns appear, create a narrator entity with id "ent_self" and name "I".',
    ...
    '- If another person is explicitly stated as role holder (e.g., "Egle was driving"), do not also assign that role to narrator from a collective "we" phrase unless "I was ..." is explicit.',
